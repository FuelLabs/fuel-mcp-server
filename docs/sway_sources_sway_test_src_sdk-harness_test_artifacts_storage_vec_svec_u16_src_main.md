# Example: sway_sources/sway/test/src/sdk-harness/test_artifacts/storage_vec/svec_u16/src/main.sw
...
abi MyContract {
    ...
    #[storage(read, write)]
    fn remove(index: u64) -> u16;

    #[storage(read, write)]
    fn swap_remove(index: u64) -> u16;

    #[storage(read, write)]
    fn set(index: u64, value: u16);

    #[storage(read, write)]
    fn insert(index: u64, value: u16);
