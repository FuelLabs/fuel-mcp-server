...
## _Icon Link_ [Sway LSP](https://docs.fuel.network/docs/sway/lsp/\#sway-lsp)
...
- [Installation](https://docs.fuel.network/docs/sway/lsp/installation/)
- [Features](https://docs.fuel.network/docs/sway/lsp/features/)
- [Troubleshooting](https://docs.fuel.network/docs/sway/lsp/troubleshooting/)