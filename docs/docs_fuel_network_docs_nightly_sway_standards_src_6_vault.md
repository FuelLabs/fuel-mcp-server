...
## _Icon Link_ [SRC-6: Vault](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#src-6-vault)

The following standard allows for the implementation of a standard API for asset vaults such as yield-bearing asset vaults or asset wrappers. This standard is an optional add-on to the [SRC-20](https://docs.fuel.network/docs/nightly/sway-standards/src-20-native-asset/) standard.

## _Icon Link_ [Motivation](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#motivation)
...
## _Icon Link_ [Prior Art](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#prior-art)
...
## _Icon Link_ [Specification](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#specification)

## _Icon Link_ [Required public functions](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#required-public-functions)
...
## _Icon Link_ [`fn deposit(receiver: Identity, vault_sub_id: SubId) -> u64`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#fn-depositreceiver-identity-vault_sub_id-subid---u64)
...
## _Icon Link_ [`fn withdraw(receiver: Identity, underlying_asset: AssetId, vault_sub_id: SubId) -> u64`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#fn-withdrawreceiver-identity-underlying_asset-assetid-vault_sub_id-subid---u64)
...
## _Icon Link_ [`fn managed_assets(underlying_asset: AssetId, vault_sub_id: SubId) -> u64`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#fn-managed_assetsunderlying_asset-assetid-vault_sub_id-subid---u64)
...
## _Icon Link_ [`fn max_depositable(receiver: Identity, underlying_asset: AssetId, vault_sub_id: SubId) -> Option<u64>`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#fn-max_depositablereceiver-identity-underlying_asset-assetid-vault_sub_id-subid---optionu64)
...
## _Icon Link_ [`fn max_withdrawable(receiver: Identity, underlying_asset: AssetId, vault_sub_id: SubId) -> Option<u64>`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#fn-max_withdrawablereceiver-identity-underlying_asset-assetid-vault_sub_id-subid---optionu64)
...
## _Icon Link_ [Required logs](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#required-logs)

The following logs MUST be emitted at the specified occasions.

## _Icon Link_ [`Deposit`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#deposit)
...
## _Icon Link_ [`Withdraw`](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#withdraw)
...
## _Icon Link_ [Rationale](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#rationale)

The ABI discussed covers the known use cases of asset vaults while allowing safe implementations.

## _Icon Link_ [Backwards Compatibility](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#backwards-compatibility)

This standard is fully compatible with the [SRC-20 standard](https://docs.fuel.network/docs/nightly/sway-standards/src-20-native-asset/).

## _Icon Link_ [Security Considerations](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#security-considerations)
...
## _Icon Link_ [Example ABI](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#example-abi)
...
## _Icon Link_ [Example Implementation](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#example-implementation)

## _Icon Link_ [Multi Asset Vault](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#multi-asset-vault)
...
## _Icon Link_ [Single Asset Vault](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#single-asset-vault)
...
## _Icon Link_ [Single Asset Single Sub Vault](https://docs.fuel.network/docs/nightly/sway-standards/src-6-vault/\#single-asset-single-sub-vault)
