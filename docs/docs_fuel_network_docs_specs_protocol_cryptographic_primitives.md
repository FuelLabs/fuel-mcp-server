...
A specification describing a suite of test vectors and outputs of a Sparse Merkle Tree is [here](https://docs.fuel.network/docs/specs/tests/sparse-merkle-tree-tests/).
