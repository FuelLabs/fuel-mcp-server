...
## _Icon Link_ [Determine](https://docs.fuel.network/docs/forc/commands/forc%5fpredicate-root/\#forc-predicate-root)
...
## _Icon Link_ [Get predicate root](https://docs.fuel.network/docs/forc/commands/forc%5fpredicate-root/\#forc-predicate-root)
