# Example: test/src/e2e_vm_tests/test_programs/should_pass/language/references/reassigning_via_references_passed_and_returned_to_and_from_functions/src/impls.sw
