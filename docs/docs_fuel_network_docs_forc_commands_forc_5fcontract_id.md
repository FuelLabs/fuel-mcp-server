...
## _Icon Link_ [Determine](https://docs.fuel.network/docs/forc/commands/forc%5fcontract-id/\#forc-contract-id)
...
## _Icon Link_ [Get contract id](https://docs.fuel.network/docs/forc/commands/forc%5fcontract-id/\#forc-contract-id)

forc contract-id

## _Icon Link_ [Get contract id from a different path](https://docs.fuel.network/docs/forc/commands/forc%5fcontract-id/\#forc-contract-id)
