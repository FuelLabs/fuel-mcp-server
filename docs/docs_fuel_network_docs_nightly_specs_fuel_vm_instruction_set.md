...
- [Arithmetic/Logic (ALU) Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#arithmeticlogic-alu-instructions)
  ...
  - [`SRL`: Shift right logical](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#srl-shift-right-logical)
...
- [Memory Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#memory-instructions)
...
- [Contract Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#contract-instructions)
  ...
  - [`CSIZ`: Code size](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#csiz-code-size)
...
## _Icon Link_ [Effects](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#effects)
...
## _Icon Link_ [`WDOP`: Misc 128-bit integer operations](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#wdop-misc-128-bit-integer-operations)
...
## _Icon Link_ [`WQOP`: Misc 256-bit integer operations](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#wqop-misc-256-bit-integer-operations)
...
## _Icon Link_ [`WDAM`: Modular 128-bit integer addition](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#wdam-modular-128-bit-integer-addition)
...
## _Icon Link_ [`WDMM`: Modular 128-bit integer multiplication](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#wdmm-modular-128-bit-integer-multiplication)
...
## _Icon Link_ [`XOR`: XOR](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#xor-xor)
...
## _Icon Link_ [Contract Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#contract-instructions)
...
Code root computation is defined [here](https://docs.fuel.network/docs/nightly/specs/identifiers/contract-id/).
...
## _Icon Link_ [`MINT`: Mint new coins](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#mint-mint-new-coins)
...
## _Icon Link_ [`RETD`: Return from context with data](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#retd-return-from-context-with-data)

|  |  |
| --- | --- |
| Description | Returns from [context](https://docs.fuel.network/docs/nightly/nightly/#contexts) with value `MEM[$rA, $rB]`. |
...
| `digest` | `byte[32]` | [Hash](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#s256-sha-2-256) of `MEM[$rA, $rB]`. |
| `pc` | `uint64` | Value of register `$pc`. |
| `is` | `uint64` | Value of register `$is`. |
...
## _Icon Link_ [`RVRT`: Revert](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#rvrt-revert)
...
1. All [`OutputContract`](https://docs.fuel.network/docs/nightly/specs/tx-format/output/#outputcontract) outputs will have the same `balanceRoot` and `stateRoot` as on initialization.
2. All [`OutputVariable`](https://docs.fuel.network/docs/nightly/specs/tx-format/output/#outputvariable) outputs will have `to`, `amount`, and `asset_id` of zero.

## _Icon Link_ [`SMO`: Send message out](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#smo-send-message-out)
...
| `nonce` | `byte[32]` | The message nonce as described [here](https://docs.fuel.network/docs/nightly/specs/identifiers/utxo-id/#message-nonce). |
| `len` | `uint64` | Length of message data, in bytes: `$rC`. |
| `digest` | `byte[32]` | [Hash](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/#s256-sha-2-256) of `MEM[$rB, $rC]`. |
...
## _Icon Link_ [`SCWQ`: State clear sequential 32 byte slots](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#scwq-state-clear-sequential-32-byte-slots)
...
- `$rA + 32` overflows or `> VM_MAX_RAM`
- `$rB` is a [reserved register](https://docs.fuel.network/docs/nightly/nightly/#semantics)
- `$fp == 0` (in the script context)
...
## _Icon Link_ [`SRW`: State read word](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#srw-state-read-word)
...
## _Icon Link_ [`SRWQ`: State read sequential 32 byte slots](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#srwq-state-read-sequential-32-byte-slots)
...
- `$rB` is a [reserved register](https://docs.fuel.network/docs/nightly/nightly/#semantics)
- The memory range `MEM[$rA, 32 * rD]` does not pass [ownership check](https://docs.fuel.network/docs/nightly/nightly/#ownership)
- `$fp == 0` (in the script context)
...
## _Icon Link_ [`SWW`: State write word](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#sww-state-write-word)
...
## _Icon Link_ [`SWWQ`: State write sequential 32 byte slots](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#swwq-state-write-sequential-32-byte-slots)
...
## _Icon Link_ [`TIME`: Timestamp at height](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#time-timestamp-at-height)
...
Gets the timestamp of the block at height `$rB`. Time is in [TAI64 _Icon Link_](https://cr.yp.to/libtai/tai64.html) format.

## _Icon Link_ [`TR`: Transfer coins to contract](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#tr-transfer-coins-to-contract)
...
## _Icon Link_ [`TRO`: Transfer coins to output](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#tro-transfer-coins-to-output)
...
## _Icon Link_ [Blob Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#blob-instructions)

All these instructions advance the program counter `$pc` by `4` after performing their operation.

## _Icon Link_ [`BSIZ`: Blob size](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#bsiz-blob-size)
...
## _Icon Link_ [`BLDD`: Load data from a blob](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#bldd-load-data-from-a-blob)
...
## _Icon Link_ [Cryptographic Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#cryptographic-instructions)

All these instructions advance the program counter `$pc` by `4` after performing their operation.

## _Icon Link_ [`ECK1`: Secp256k1 signature recovery](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#eck1-secp256k1-signature-recovery)
...
- `$rC + 32` overflows or `> VM_MAX_RAM`
- The memory range `MEM[$rA, 64]` does not pass [ownership check](https://docs.fuel.network/docs/nightly/nightly/#ownership)

Signatures and signature verification are specified [here](https://docs.fuel.network/docs/nightly/specs/protocol/cryptographic-primitives/#ecdsa-public-key-cryptography).

If the signature cannot be verified, `MEM[$rA, 64]` is set to `0` and `$err` is set to `1`, otherwise `$err` is cleared.

To get the address from the public key, hash the public key with [SHA-2-256](https://docs.fuel.network/docs/nightly/specs/protocol/cryptographic-primitives/#hashing).

## _Icon Link_ [`ECR1`: Secp256r1 signature recovery](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#ecr1-secp256r1-signature-recovery)
...
## _Icon Link_ [`ED19`: EdDSA curve25519 verification](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#ed19-eddsa-curve25519-verification)
...
Verification are specified [here](https://docs.fuel.network/docs/nightly/specs/protocol/cryptographic-primitives/#eddsa-public-key-cryptography).

If there is an error in verification, `$err` is set to `1`, otherwise `$err` is cleared.

## _Icon Link_ [`K256`: keccak-256](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#k256-keccak-256)
...
## _Icon Link_ [`S256`: SHA-2-256](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#s256-sha-2-256)
...
## _Icon Link_ [`ECOP`: Elliptic curve point operation](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#ecop-elliptic-curve-point-operation)
...
## _Icon Link_ [Curve ID `$rB` possible values](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#curve-id-rb-possible-values)

- `0`: `alt_bn128` elliptic curve.

## _Icon Link_ [Operation type `$rC` supported](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#operation-type-rc-supported)

- `0`: two points addition
- `1`: one point and one scalar multiplication

## _Icon Link_ [Encoding of points and results by curve ID and operation type](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#encoding-of-points-and-results-by-curve-id-and-operation-type)
...
## _Icon Link_ [Panic cases](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#panic-cases)
...
- The memory range at `$rA` (size depending on the curve/operation types) does not pass [ownership check](https://docs.fuel.network/docs/nightly/nightly/#ownership)

## _Icon Link_ [`EPAR`: Elliptic curve point pairing check](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#epar-elliptic-curve-point-pairing-check)
...
## _Icon Link_ [Curve/Pairing ID `$rB` possible values](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#curvepairing-id-rb-possible-values)

- `0`: optimal ate pairing on `alt_bn128` elliptic curve.

## _Icon Link_ [Encoding of points by curve ID and check type](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#encoding-of-points-by-curve-id-and-check-type)
...
## _Icon Link_ [Panic cases](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#panic-cases-1)
...
## _Icon Link_ [Other Instructions](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#other-instructions)

All these instructions advance the program counter `$pc` by `4` after performing their operation.

## _Icon Link_ [`ECAL`: Call external function](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#ecal-call-external-function)
...
## _Icon Link_ [`FLAG`: Set flags](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#flag-set-flags)
...
## _Icon Link_ [`GM`: Get metadata](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#gm-get-metadata)
...
## _Icon Link_ [`GTF`: Get transaction fields](https://docs.fuel.network/docs/nightly/specs/fuel-vm/instruction-set/\#gtf-get-transaction-fields)
...
Get [fields from the transaction](https://docs.fuel.network/docs/nightly/specs/tx-format/transaction/).
