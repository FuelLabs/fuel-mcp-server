...
## _Icon Link_ [Determine](https://docs.fuel.network/docs/nightly/forc/commands/forc_predicate-root/\#forc-predicate-root)
...
## _Icon Link_ [Get predicate root](https://docs.fuel.network/docs/nightly/forc/commands/forc_predicate-root/\#forc-predicate-root)
