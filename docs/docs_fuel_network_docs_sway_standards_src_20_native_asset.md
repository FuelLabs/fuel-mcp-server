...
## _Icon Link_ [SRC-20: Native Asset](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#src-20-native-asset)
...
## _Icon Link_ [Motivation](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#motivation)
...
## _Icon Link_ [Prior Art](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#prior-art)
...
## _Icon Link_ [Specification](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#specification)

## _Icon Link_ [Required Public Functions](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#required-public-functions)

The following functions MUST be implemented to follow the SRC-20 standard:

## _Icon Link_ [`fn total_assets() -> u64`](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#fn-total_assets---u64)

This function MUST return the total number of individual assets for a contract.

## _Icon Link_ [`fn total_supply(asset: AssetId) -> Option<u64>`](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#fn-total_supplyasset-assetid---optionu64)
...
## _Icon Link_ [`fn name(asset: AssetId) -> Option<String>`](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#fn-nameasset-assetid---optionstring)
...
## _Icon Link_ [`fn symbol(asset: AssetId) -> Option<String>`](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#fn-symbolasset-assetid---optionstring)
...
## _Icon Link_ [`fn decimals(asset: AssetId) -> Option<u8>`](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#fn-decimalsasset-assetid---optionu8)
...
## _Icon Link_ [Non-Fungible Asset Restrictions](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#non-fungible-asset-restrictions)
...
## _Icon Link_ [Logging](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#logging)
...
## _Icon Link_ [SetNameEvent](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#setnameevent)
...
## _Icon Link_ [SetSymbolEvent](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#setsymbolevent)
...
## _Icon Link_ [SetDecimalsEvent](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#setdecimalsevent)
...
## _Icon Link_ [UpdateTotalSupplyEvent](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#updatetotalsupplyevent)
...
## _Icon Link_ [Rationale](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#rationale)
...
## _Icon Link_ [Backwards Compatibility](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#backwards-compatibility)
...
## _Icon Link_ [Security Considerations](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#security-considerations)

This standard does not introduce any security concerns, as it does not call external contracts, nor does it define any mutations of the contract state.

## _Icon Link_ [Example ABI](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#example-abi)
...
## _Icon Link_ [Example Implementation](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#example-implementation)

## _Icon Link_ [Single Native Asset](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#single-native-asset)
...
## _Icon Link_ [Multi Native Asset](https://docs.fuel.network/docs/sway-standards/src-20-native-asset/\#multi-native-asset)
