# Example: sway_sources/sway/test/src/e2e_vm_tests/test_programs/should_pass/language/references/dereferencing_operator_dot_on_structs/src/main.sw
    ...
    T: TestInstance + Eq,
{
    ...
    let embed = EmbedsReferences {
        x: & & &s1,
        y: & &s2,
    };
    let mut embed_mut = EmbedsReferencesMut {
        x: &mut &mut &mut s1,
        y: &mut &mut s2,
    };
    ...
    let r = & & & & &EmbedsReferencesMut {
        x: &mut &mut &mut T::new(),
        y: &mut &mut T::different(),
    };
