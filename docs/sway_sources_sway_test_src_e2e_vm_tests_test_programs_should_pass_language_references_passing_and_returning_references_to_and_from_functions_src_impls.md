# Example: sway_sources/sway/test/src/e2e_vm_tests/test_programs/should_pass/language/references/passing_and_returning_references_to_and_from_functions/src/impls.sw
