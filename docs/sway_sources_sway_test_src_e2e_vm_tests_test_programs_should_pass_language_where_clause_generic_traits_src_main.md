# Example: sway_sources/sway/test/src/e2e_vm_tests/test_programs/should_pass/language/where_clause_generic_traits/src/main.sw
...
fn main() {
    assert_eq(1_u64.method2(), 3);

    assert_eq(1_u32.method3(), 3);
}
```
