# Example: sway_sources/sway/test/src/sdk-harness/test_artifacts/storage_vec/svec_u64/src/main.sw
...
abi MyContract {
    ...
    #[storage(read)]
    fn get(index: u64) -> u64;

    #[storage(read, write)]
    fn remove(index: u64) -> u64;

    #[storage(read, write)]
    fn swap_remove(index: u64) -> u64;

    #[storage(read, write)]
    fn set(index: u64, value: u64);

    #[storage(read, write)]
    fn insert(index: u64, value: u64);
    ...
    #[storage(read, write)]
    fn resize(new_len: u64, value: u64);
}
