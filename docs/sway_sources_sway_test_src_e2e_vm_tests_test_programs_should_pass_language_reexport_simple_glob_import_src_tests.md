# Example: sway_sources/sway/test/src/e2e_vm_tests/test_programs/should_pass/language/reexport/simple_glob_import/src/tests.sw

```sway
library;

use ::lib_1::*; // Reexported items from items_1.sw. All reexports are item imports
use ::lib_2::*; // Reexported items from items_2.sw. All reexports are glob imports
