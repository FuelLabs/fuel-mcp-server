# Example: sway_sources/sway/test/src/in_language_tests/test_programs/primitive_conversions_u16_inline_tests/src/main.sw

```sway
library;

use std::{primitive_conversions::u16::*, u128::*};
