...
## _Icon Link_ [Transferring Assets To Multiple Contracts](https://docs.fuel.network/docs/nightly/fuels-ts/wallets/wallet-transferring/\#transferring-assets-to-multiple-contracts)
