...
## _Icon Link_ [Deploying Predicates](https://docs.fuel.network/docs/nightly/fuels-ts/predicates/deploying-predicates/\#deploying-predicates)

In order to optimize the cost of your recurring predicate executions, we recommend first deploying your predicate. This can be done using the [Fuels CLI](https://docs.fuel.network/docs/nightly/fuels-ts/fuels-cli/) and running the [deploy command](https://docs.fuel.network/docs/nightly/fuels-ts/fuels-cli/commands/#fuels-deploy).
...
## _Icon Link_ [How to Deploy a Predicate](https://docs.fuel.network/docs/nightly/fuels-ts/predicates/deploying-predicates/\#how-to-deploy-a-predicate)

To deploy a predicate, we can use the [Fuels CLI](https://docs.fuel.network/docs/nightly/fuels-ts/fuels-cli/) and execute the [deploy command](https://docs.fuel.network/docs/nightly/fuels-ts/fuels-cli/commands/#fuels-deploy).
