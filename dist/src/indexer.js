 ...
 */
async function getOrCreateQdrantCollection(client, collectionName) {
    try {
 ...
 */
export async function indexDocsQdrant(docsDir, collectionName = DEFAULT_QDRANT_COLLECTION, modelName = DEFAULT_MODEL, targetChunkSize = TARGET_TOKEN_SIZE) {
    ...
    for (let i = 0; i < allChunks.length; i += BATCH_SIZE) {
        ...
        try {
            ...
            await client.upsert(collectionName, {
                ...
                points: points // Cast as any to bypass stricter type check after filtering nulls
